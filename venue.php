            ...
            <div class="row">
                <div class="col-xl-6 col-md-6">
                    <div class="single_venue">
                        ...
                        <h6 align="center">Rp. 300.000.-/Night</h6>
                        <h4>Facility</h4>
                        <ul>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="single_venue">
                        ...
                        <h6 align="center">Rp. 400.000.-/Night</h6>
                        <h4>Facility</h4>
                        <ul>
                            <li>Air Conditioner</li>
                            <li>TV Cable</li>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="single_venue">
                        ...
                        <h6 align="center">Rp. 500.000.-/Night</h6>
                        <h4>Facility</h4>
                        <ul>
                            <li>Air Conditioner</li>
                            <li>TV Cable</li>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="single_venue">
                        ...
                        <h6 align="center">Rp. 700.000.-/Night</h6>
                        <h4>Facility</h4>
                        <ul>
                            <li>Air Conditioner</li>
                            <li>TV Cable</li>
                ...
                <div class="col-xl-12 col-md-4 col-s-2">
                    <center><a href="#test-form" class="popup-with-form book_now">Booking Rooms</a><center>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-md-4">
                <div class="single_venue">
                    ...
                    <h6 align="center">Rp. 100.000.-/Hour</h6>
                        <h4>Facility</h4>
                        <ul>
            ...
            <div class="col-xl-4 col-md-4">
                <div class="single_venue">
                    ...
                    <h3 align="center">Meeting Room</h3>
                    <h6 align="center">Rp. 150.000.-/Hour</h6>
                        <h4>Facility</h4>
                        <ul>
                            <li>Fully equipped with Screen</li>
                            <li>LCD Projector</li> 
            ...
            <div class="col-xl-4 col-md-4">
                <div class="single_venue">
                    ...
                    <h3 align="center">Meeting Room</h3>
                    <h6 align="center">Rp. 200.000.-/Hour</h6>
                        <h4>Facility</h4>
                        <ul>
                            <li>Fully equipped with Screen</li>
                            <li>LCD Projector</li> 
            ...
            <div class="col-xl-12 col-md-4 col-s-2">
            <center><a href="#test-form" class="popup-with-form book_now">Booking Meeting Rooms</a><center>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="row">
        <div class="col-xl-6 col-md-6">
            <div class="single_venue">
                ...
                <h6 align="center">Rp. 600.000.-/Hour</h6>
                    <h4>Facility</h4>
                    <ul>
        ...
        <div class="col-xl-6 col-md-6">
            <div class="single_venue">
                ...
                <h3 align="center">BallRoom</h3>
                <h6 align="center">Rp. 700.000.-/Hour</h6>
                    <h4>Facility</h4>
                    <ul>
                        <li>Spacious and Comfortable</li>
                            <li>300 person</li>
        ...
        <div class="col-xl-12 col-md-4 col-s-2">
        <center><a href="#test-form" class="popup-with-form book_now">Booking Ballrooms</a><center>
        </div>
     </div>
     <br>
     <br>
