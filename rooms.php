        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item"><a href="rooms.php">rooms</div></a>
            </div>
          </div>
            <?php
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-striped table-hover" id="table-1">
                      ...
                      <tbody>
                        <?php
                        $data = mysqli_query($koneksi,"SELECT * FROM tbl_rooms");
                        $no=0;
                        while ($select_result = mysqli_fetch_array($data))
                        {
                          $id = $select_result['id_rooms'];
            ...
            <div class="row">
              <div class="col-12">
                <div class="card card-primary">
                  <br>
                  <div class="col-12">
                    <form action="simpan_rooms.php" method="post">
                      <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="nama_kamar" class="form-control" placeholder="Masukan Nama" required="">
                      </div>
                      <div class="form-group">
                        <label>Jumlah Kamar</label>
                        <input type="number" name="jumlah" class="form-control" placeholder="Masukan Jumlah Kamar" required="">
                      </div>
                      <div class="form-group">
                        <label>Harga Kamar</label>
                        <input type="number" name="harga" class="form-control" placeholder="Masukan Harga Kamar" required>
                      </div>
                      <br>
                      <div>
