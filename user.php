        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item"><a href="user.php">user</div></a>
            </div>
          </div>
            <?php
                ...
                <div class="card card-primary">
                  ...
                  <div class="col-12">
                    <form action="simpan_user.php" method="post">
                      ...
                      <div class="form-group">
                        <label>Akses</label>
                        <input class="form-control" type="text" name="hak_akses" readonly="" value="User">
                    </div>
                      <br>
                      <div>
